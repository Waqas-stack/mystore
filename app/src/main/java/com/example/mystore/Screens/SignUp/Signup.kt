package com.example.mystore.Screens.SignUp
...
fun SignUp(navController: NavHostController) {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(color = colorResource(id = R.color.scfool_color)),
...
//        verticalArrangement = Arrangement.Center
        ...
        Row(
            ...
            Text(text = "Sign up", fontWeight = FontWeight.W600, fontSize = 16.sp)
            ...
            TextField(
                ...
                trailingIcon = {
                    Icon(
                        ...
                        contentDescription = "Back Arrow Icon",
                        tint = colorResource(id = R.color.signupdone_color),
